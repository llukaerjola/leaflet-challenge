...
d3.json(url).then(function (data) { //pull the earthquake JSON data with d3
    L.geoJson(data, {
        pointToLayer: function (feature, latlon) {  //declare a point to layer function that takes a feature and latlon
            return L.circleMarker(latlon).bindPopup("<h3>" +feature.properties.place +  feature.geometry.coordinates[2]  + feature.properties.mag ); //function creates a circleMarker at latlon and binds a popup with the earthquake id
        },
